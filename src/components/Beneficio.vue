<template>
    ...
    <div class="grid" v-show="fase == 0">
        ...
        <div class="grid align-content-start section-beneficio" style="">
            ...
            <h3>Nombre del negocio: {{beneficio.nombre_negocio}} </h3>
            <h3>Tipo de negocio: {{beneficio.tipo_negocio}}</h3>
            <h3>Dirección: {{beneficio.direccion}}</h3>
            <h3>Teléfono: {{beneficio.telefono}}</h3>
        </div>

        <div class="grid align-content-center" style="grid-gap:20px">

            <button class="btn btn-orange" @click="fase = 1">SIGUIENTE</button>
    ...
    <div class="grid vmodel-img" v-show="fase == 1">
        ...
        <button class="btn btn-orange-second" @click="Cancelar" style="width:30%">CANCELAR</button>
    ...
    <div class="grid" v-show="fase == 2">
        ...
        <div class="grid align-content-start section-beneficio" style="margin-bottom:20px" >
            ...
            <div class="grid">
                ...
                <textarea name="" v-model="beneficio.descripcion" class="textarea" id=""  placeholder="Descripción del beneficio" cols="30" rows="10">

                </textarea>

                <input type="text" @keydown="SoloNumeros($event)" maxlength="4" v-model="beneficio.puntos" class="input" placeholder="Valor en puntos">
    ...
    <div class="grid" v-if="fase == 3">

        <div class="grid align-content-start section-beneficio" >
            <h1>Este será el QR y el código para utilizar el cupón</h1>
        </div>
        ...
        <div class="grid align-content-center" style="grid-gap:20px">
            ...
            <button class="btn btn-orange" @click="fase =4">SIGUIENTE</button>
    ...
    export default {
        ...
        data() {
            return {
                ...
                beneficio:{
                    tipo:0,
                    titulo:null,
                    nombre_negocio:'Alimas',
                    tipo_negocio:'Tipo_Alimas',
                    direccion:'Dirección_Alimas',
                    telefono:'5551124',
                    fecha_desde:null,
                    fecha_hasta:null,
                    descripcion:null,
        ...
        //FUNCIONES
            ...
            async Insert(){
                ...
                if(this.Vacio() || (this.beneficio.descuento == null && this.beneficio.precio == null)){
                    this.$swal.fire({
                        icon:'error',
            ...
            async Editar(){
                ...
                await axios.post(process.env.VUE_APP_API+'EditBeneficioInt',this.beneficio).then( ()=> {
                    this.fase = 4;
                    this.vm_visible= false;
